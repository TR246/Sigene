...
var _slicedToArray = (function() {
  function b(d, f) {
    ...
    try {
      for (
        var p, o = d[Symbol.iterator]();
        !(k = (p = o.next()).done) && (g.push(p.value), !(f && g.length === f));
        k = !0
      );
    } catch (q) {
      (l = !0), (m = q);
...
(function() {
  function b(H, I, J, K, L) {
    ...
    (T.fillStyle = "#000"),
      ...
      z[L.signType](S, T, L);
    for (
      var U = S.getImageData(0, 0, I, J),
        V = T.getImageData(0, 0, I, J),
        W = U.data,
        X = V.data,
        Y = 0;
      Y < I * J;
    ...
    S.putImageData(U, 0, 0),
      H.drawImage(Q, N.left, N.top),
      L.signBoard.light && M.shadow(H, O, P, K, L);
  }
  var d =
      "'Mplus 1p', 'Hiragino Sans', 'Hiragino Kaku Gothic ProN', 'M+ 1p', sans-serif",
    f = "'Helvetica', 'Arial', sans-serif",
    g = "Cabin', 'Open Sans', 'Lato', 'sans-serif",
    m = function() {
      return {
        signType: "jre-kanji",
        signBoard: { type: "SE-6", light: !0 },
        numbering: !0,
        branchRight: !1,
        branchLeft: !1,
        black: "#1A1A1A",
        ...
        rightStations: [
          {
            ...
            lineColor: "#006400",
            go: !1,
            numberings: [{ text: "JY 16", color: "#72C11D" }]
          },
          {
            name: { kanji: "", english: "" },
            lineColor: "#006400",
        ...
        leftStations: [
          {
            name: { kanji: "\u4EE3\u3005\u6728", english: "Yoyogi" },
            lineColor: "#006400",
            go: !0,
            numberings: [{ text: "JY 18", color: "#72C11D" }]
          },
          {
            name: { kanji: "", english: "" },
            lineColor: "#006400",
  ...
  var o = {
      stringify: function stringify(H) {
        function I(S) {
          (R += P(S.name.kanji)),
            (R += P(S.name.english)),
            (R += S.lineColor.slice(1)),
            (R += S.go ? "1" : "0"),
            J && S.go && (R += Q(S.numberings));
        }
        var P = function(S) {
            return S.length + ":" + S;
          },
        ...
        return (
          ...
          J &&
            ((R += P(M.name.chinese)),
            (R += P(M.name.korean)),
            (R += M.enableTlc ? "1" + M.tlc : "0"),
            (R += Q(M.numberings))),
          I(H.rightStations[0]),
          K && I(H.rightStations[1]),
          I(H.leftStations[0]),
          L && I(H.leftStations[1]),
          (R +=
            N.length +
            ":" +
            N.map(function(S) {
      ...
      parse: function parse(H) {
        ...
        var J = 0,
          ...
          L = function(Z) {
            ...
            for (var ba = 0; ba < _; ba++) {
              ...
              aa.push({ text: da, color: "#" + ea }), (J = ca + 1);
            }
            return aa;
          },
          M = m(),
        ...
        var O = H.indexOf(",", J);
        (M.signBoard.type = H.slice(J, O)),
          (J = O + 1),
          (M.signBoard.light = !!(H[J] - 0));
        var P = !!(H[++J] - 0);
        M.numbering = P;
        var Q = !!(H[++J] - 0);
        M.branchRight = Q;
        ...
        if (
          ((M.branchLeft = R),
          (M.black = "#" + H.substr(++J, 6)),
          (J += 6),
          (M.sta.name.kanji = K(J)),
          (M.sta.name.english = K(J)),
          (M.sta.name.kana = K(J)),
          P)
        ) {
          ...
          var S = !!(H[J++] - 0);
          (M.sta.enableTlc = S),
            S ? ((M.sta.tlc = H.substr(J, 3)), (J += 3)) : (M.sta.tlc = ""),
            (M.sta.numberings = L(J));
        } else
          (M.sta.chinese = ""),
            (M.sta.korean = ""),
            (M.sta.enableTlc = !1),
            ...
            (M.sta.numberings = []);
        I(M.rightStations[0]),
          Q && I(M.rightStations[1]),
          I(M.leftStations[0]),
          R && I(M.leftStations[1]),
          (M.cityNotations = []);
        var T = H.indexOf(":", J),
          U = H.slice(J, T) - 0;
        J = T + 1;
        for (var V = 0; V < U; V++)
          M.cityNotations.push({ text: H[J], fill: !!(H[J + 1] - 0) }),
            (J += 2);
        M.routeColors = [];
        var W = H.indexOf(":", J),
          X = H.slice(J, W) - 0;
        J = W + 1;
        for (var Y = 0; Y < X; Y++)
          M.routeColors.push("#" + H.substr(J, 6)), (J += 6);
        return M;
      }
    },
    p = function(H, I, J, K) {
    ...
    q = function(H, I, J, K, L, M) {
      H.beginPath(),
        H.moveTo(I, J + M),
        H.arcTo(I, J, I + K - M, J, M),
        H.arcTo(I + K, J, I + K, J + L - M, M),
        H.arcTo(I + K, J + L, I + M, J + L, M),
        H.arcTo(I, J + L, I, J + M, M),
        H.closePath();
    },
    u = {
      draw: function draw(H, I, J, K, L) {
        (H.fillStyle = "#333"),
          ...
          H.lineTo(I - 6, J),
          (H.lineWidth = 2),
          (H.strokeStyle = "#1A1A1A"),
          H.stroke(),
          H.beginPath(),
          H.moveTo(10, 6),
          H.lineTo(10, this.padding.top),
          (H.lineWidth = 1),
          H.stroke(),
          H.beginPath(),
          H.moveTo(I - 10, 6),
          H.lineTo(I - 10, this.padding.top),
          H.stroke(),
          H.beginPath(),
          H.moveTo(6, this.padding.top),
          H.lineTo(I - 6, this.padding.top),
          H.stroke();
        var M = H.createLinearGradient(0, J, 0, J - 8);
        M.addColorStop(0, "rgba(0, 0, 0, 0.5)"),
          M.addColorStop(1, "rgba(0, 0, 0, 0)"),
          (H.fillStyle = M),
          H.fillRect(7, J - 8, I - 14, 8),
          (H.shadowColor = "#000"),
          (H.shadowBlur = 5),
          (H.fillStyle = "#333"),
          H.fillRect(10, J - this.padding.bottom, I - 20, 10),
          (H.shadowColor = "rgba(0, 0, 0, 0)"),
          (H.shadowBlur = 0),
          (H.fillStyle = L.signBoard.light ? "#F0F8FF" : "#EEE"),
          H.fillRect(
            this.padding.left,
            this.padding.top,
      ...
      shadow: function shadow(H, I, J) {
        ...
        (O.width = M),
          ...
          P.fillRect(30, 30 - N, M - 60, N - 60),
          (P.shadowBlur = 100),
          P.beginPath(),
          P.moveTo(100, 100 - N),
          P.lineTo(M - 100, 100 - N),
          P.lineTo(M - 200, -200),
          P.lineTo(200, -200),
          P.closePath(),
          P.fill();
        ...
        (Q.width = M),
          ...
          R.fillRect(0, 0, M, N);
        for (
          var S = P.getImageData(0, 0, M, N),
            T = R.getImageData(0, 0, M, N),
            U = S.data,
            V = T.data,
            W = 0;
          W < M * N;
          ...
          V[4 * W + 3] = 0.2 * (U[4 * W] - 63);
        R.putImageData(T, 0, 0),
          H.drawImage(Q, this.padding.left, this.padding.top);
      }
    },
    w = {
      "SE-6": {
        padding: { top: 80, bottom: 30, left: 35, right: 35 },
        width: 1830,
        height: 490,
        draw: u.draw,
        shadow: u.shadow
      ...
      "SE-8": {
        padding: { top: 80, bottom: 30, left: 40, right: 40 },
        width: 3620,
        height: 490,
        draw: u.draw,
        shadow: u.shadow
    ...
    z = {
      "jre-kanji": function jreKanji(H, I, J) {
        ...
        I.beginPath(),
          J.branchRight
            ? (I.moveTo(K - V, S),
              I.lineTo(K - V + 65, S - 65),
              J.rightStations[0].go
                ? (I.lineTo(K - 130, S - 65),
                  I.lineTo(K - 50, S - 25),
                  I.lineTo(K - 130, S + 12))
                : (I.lineTo(K, S - 65), I.lineTo(K, S + 12)),
              I.lineTo(K - V + 100, S + 12),
              I.lineTo(K - V + 60, P),
              I.lineTo(K - V + 100, U - 12),
              J.rightStations[1].go
                ? (I.lineTo(K - 130, U - 12),
                  I.lineTo(K - 50, U + 25),
                  I.lineTo(K - 130, U + 65))
                : (I.lineTo(K, U - 12), I.lineTo(K, U + 65)),
              I.lineTo(K - V + 65, U + 65),
              I.lineTo(K - V, U))
            : J.rightStations[0].go
              ? (I.moveTo(K - 160, S),
                I.lineTo(K - 65, P),
                I.lineTo(K - 160, U))
              : (I.moveTo(K, S), I.lineTo(K, U)),
          J.branchLeft
            ? (I.lineTo(V, U),
              I.lineTo(V - 65, U + 65),
              J.leftStations[1].go
                ? (I.lineTo(130, U + 65),
                  I.lineTo(50, U + 25),
                  I.lineTo(130, U - 12))
                : (I.lineTo(0, U + 65), I.lineTo(0, U - 12)),
              I.lineTo(V - 100, U - 12),
              I.lineTo(V - 60, P),
              I.lineTo(V - 100, S + 12),
              J.leftStations[0].go
                ? (I.lineTo(130, S + 12),
                  I.lineTo(50, S - 25),
                  I.lineTo(130, S - 65))
                : (I.lineTo(0, S + 12), I.lineTo(0, S - 65)),
              I.lineTo(V - 65, S - 65),
              I.lineTo(V, S))
            : J.leftStations[0].go
              ? (I.lineTo(160, U), I.lineTo(65, P), I.lineTo(160, S))
              : (I.lineTo(0, U), I.lineTo(0, S)),
          I.closePath(),
          I.fill(),
          J.branchRight
            ? ((H.fillStyle = J.rightStations[0].lineColor),
              H.fillRect(N, T - 65, O, 65 + R / 2),
              (H.fillStyle = J.rightStations[1].lineColor),
              H.fillRect(N, P, O, 65 + R / 2))
            : ((H.fillStyle = J.rightStations[0].lineColor),
              H.fillRect(N, T, O, R)),
          J.branchLeft
            ? ((H.fillStyle = J.leftStations[0].lineColor),
              H.fillRect(0, T - 65, M, 65 + R / 2),
              (H.fillStyle = J.leftStations[1].lineColor),
              H.fillRect(0, P, M, 65 + R / 2))
            : ((H.fillStyle = J.leftStations[0].lineColor),
              H.fillRect(0, T, M, R));
        for (var W = J.routeColors.length, X = Q / W, Z = 0; Z < W; Z++)
          (H.fillStyle = J.routeColors[Z]),
            H.fillRect(M - Q / 2, Z ? S + X * Z : T, Q, Math.ceil(X));
        var $ = function(ua) {
            var va = ua.x,
              wa = ua.y,
              xa = ua.text,
              ...
              Ba = ua.maxWidth,
              Ca = ua.align;
            (I.textAlign = Ca || "center"),
              (I.font = (ya || "") + " " + za + "px " + Aa),
              I.fillText(xa, va, wa, Ba),
              (H.fillStyle = J.black);
            var Da = Math.min(Ba || Infinity, I.measureText(xa).width);
            return (
              H.fillRect(
                { left: va, right: va - Da }[Ca] || va - Da / 2,
                wa - za,
                Da,
                1.22 * za
              ),
              (I.textAlign = "center"),
              Math.min(Da, Ba || Infinity)
            );
          },
          aa = function(ua, va) {
          ...
          ba = function(ua, va, wa, xa, ya, za) {
            ...
            za
              ? (q(H, ua, va, wa, wa, Aa), (H.fillStyle = ya), H.fill())
              : ((H.fillStyle = ya),
                H.fillRect(
                  Math.floor(ua),
                  Math.floor(va),
              ...
              (I.textAlign = "center"),
              (I.font = "bold " + 3 * Aa + "px " + g),
              I.fillText(Ca, ua + wa / 2, va + 4 * Aa, 0.9 * Ba),
              (I.font = "bold " + 4.4 * Aa + "px " + g),
              I.fillText(Da, ua + wa / 2, va + 8 * Aa, 0.9 * Ba);
          },
          ca = $({
            x: M,
            y: S - 120,
        ...
        if (J.numbering) {
          ...
          if (ea) {
            ...
            (H.fillStyle = J.black),
              ...
              q(I, ga, ia, ja, ka, 18 * ha),
              I.fill(),
              (I.font = "bold " + 32 * ha + "px " + g),
              (I.fillStyle = "#000"),
              I.fillText(J.sta.tlc, ga + ja / 2, ia + 30 * ha),
              (I.fillStyle = "#FFF");
          }
        ...
        var oa = function(ua, va, wa) {
          for (
            ...
            var Ba = va[za],
              ...
              Da = Math.min(
                Math.abs(Ca - (xa ? M + da / 2 : M - da / 2)) - 20,
                ua ? Math.abs(Ca - (xa ? K - V + 100 : V - 100)) : Infinity
              );
            (I.fillStyle = "#000"),
              (I.textAlign = wa),
              (I.textBaseline = "middle"),
              (I.font = "500 " + (ua ? 60 : Ba.go ? 80 : 70) + "px " + d),
              I.fillText(
                aa(Ba.name.kanji, [" "]),
                Ca,
                ua ? [S - 25, U + 25][za] : P,
            ...
            for (
              var Ha, Ea = ua ? 50 : 80, Fa = 0, Ga = Ba.numberings.length;
              J.numbering && Ba.go && Fa < Ga;
              Fa++
            )
              (Ha = Ba.numberings[Fa]),
                ba(
        ...
        oa(J.branchRight, J.rightStations, "right"),
          oa(J.branchLeft, J.leftStations, "left"),
          (I.textAlign = "center"),
          (I.lineWidth = 4),
          (I.textAlign = "center");
        for (var pa = 0, qa = J.cityNotations.length; pa < qa; pa++) {
          ...
          (H.fillStyle = J.black),
            H.fillRect(Math.floor(sa) - 3, Math.floor(ta) - 3, 86, 86),
            q(I, sa, ta, 80, 80, ra.fill ? 8 : 7),
            I[ra.fill ? "fill" : "stroke"](),
            (I.fillStyle = ra.fill ? "#000" : "#FFF"),
            (I.font = "bold 70px " + d),
            I.fillText(ra.text, sa + 40, ta + 65, 75);
        }
      }
    },
    ...
    D = function() {
      ...
      return this.$el.checkValidity()
        ? void (C.classList.remove("show"),
          localStorage.setItem(
            "lastSaved",
            LZString.compressToEncodedURIComponent(o.stringify(this))
          ),
          setTimeout(function() {
            var I = H.signBoard,
              L = w[I.type],
    ...
    F = new Vue({
      ...
      mounted: function mounted() {
        var J = this,
          ...
          I = void 0;
        location.search.match(/\?desig1=/)
          ? (I = o.parse(
              LZString.decompressFromEncodedURIComponent(
                location.search.slice(8)
              )
            ))
          : H && (I = o.parse(LZString.decompressFromEncodedURIComponent(H))),
          I &&
      ...
      data: function data() {
        return Object.assign(m(), {
          ...
          fontLoad: { japanese: !1, chinese: !1, korean: !1 },
          shareURL: "",
          blackList: [
            { color: "#1A1A1A", name: "\u9ED2" },
      ...
      methods: {
        ...
        saveAsPNG: function E() {
          var H = document.createElement("canvas"),
            ...
            K = J.padding;
          (H.width = J.width + K.left + K.right),
            (H.height = J.height + K.top + K.bottom),
            b(I, J.width, J.height, 1, this);
          var L = document.createElement("a");
          (L.download = "\u99C5\u540D\u6A19_" + this.sta.name.kanji + ".png"),
            (L.href = H.toDataURL()),
  ...
  WebFont.load({
    ...
    active: function active() {
      D.call(F), console.log("fonts loaded.");
    },
    inactive: function inactive() {
